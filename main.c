...
This file contains main function retryMainPage and mainPage function.
*/
#include<stdio.h>
#include<conio.h>
#include<stdlib.h>
...
void retryMainPage(){ //this method is used in case when a user makes a wrong choice in the main menu section.
    char loopChoice;
