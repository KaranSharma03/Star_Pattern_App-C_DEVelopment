...
void square(int *a){ //a is number of rows.
	int x,y;
...
void rhombus(int *a){	//a is the number of rows.
	int x,y;
...
void hollowSqaure(int *a){ //a is the number of rows.
	int x,y;
...
void rTriangle(int *a){ //a is the number of rows.
	int x,y;
...
void lTriangle(int *a){ //a is the number of rows.
	int x,y;
...
void inverted_R_Triangle(int *a){ //a is the number of rows.
	int x,y;
...
void inverted_L_Traingle(int *a){ //a is the number of rows.
	int x,y;
...
void pyramid(int *a){ //a is the number of rows.
	int x,y;
...
void invertedPyramid(int *a){ //a is the number of rows.
	int x,y;
...
void Diamond(int *a){ //a is the number of rows.
	int x,y, star, space;
